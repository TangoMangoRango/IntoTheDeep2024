...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -591.0601360373037; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -8509.014936948763; // x position of the perpendicular encoder (in tick units)
    }
